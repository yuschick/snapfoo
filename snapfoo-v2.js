function snapFoo(theSVGContainer) {
    ...
    var animate = {
            ...
            animate: function(theElement, theProps, theDelay, theDuration, theEasing, theOptions) {
            ...
            animatePath: function(theElement, thePath, theDelay, theDuration, theEasing, theOptions) {
                var s = Snap.select(theSVGContainer),
                    el = s.select(theElement),
                    obj = theOptions,
                ...
                setTimeout(function() {
                    Snap.animate(startPoint, endPoint, function(val) {
                        ...
                        el.attr({ transform: "t" + (movePoint.x - curX) + "," + (movePoint.y - curY) + "r" + angle + "," + curX + "," + curY });
            ...
            element: function(theElement, theFramesObj, theCallback) {
                var el = theElement,
                    obj = theFramesObj,
                    stagger = obj.stagger || 0,
                    theCallback = theCallback && typeof theCallback === 'function' ? theCallback : null,
                    callbackAt = theCallback ? obj.callbackAt || 'end' : null,
                    loop = obj.loop || false,
                            ...
                            if (i < theFramesLength) {
                                ...
                                if (theCallback) {
                                    if ((callbackAt === 'end' || callbackAt === 'loop') && (num < (totalChildren - 1))) {
                                        ...
                                        callback.logic(theCallback, theIdentifier, loop, totalDelay, callbackAt);
                                    }
                                }
            ...
            loop: function(theElement, theOptions) {
                var obj = animate.loopObj[theElement];
            ...
            path: function(theElement, theObj, theCallback) {
                var el = theElement,
                    obj = theObj,
                    path = obj.path,
                    delay = obj.delay || 0,
        ...
        callback = {
            logic: function(theCallback, theIdentifier, loop, totalDelay, callbackAt) {
                var obj = animate.loopObj[theIdentifier];
            ...
            run: function(scope, callback, delay) {
                setTimeout(function() {
        ...
        reset = {
            ...
            element: function(theIdentifier) {
            ...
            store: function(theIdentifier) {
                this.resetArray.push(theIdentifier);
            },

            transform: function(theIdentifier) {
